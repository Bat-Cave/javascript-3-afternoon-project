...
let removeDuplicates = (codes) => workplaceAccidents.filter((value,index) => workplaceAccidents.indexOf(value) === index)
removeDuplicates()
...
let recordCleaner = () => {
  myCar.accidents.forEach(key => key.atFaultForAccident = false)
}
